...
| Targets overview | [Targets](https://trivy.dev/docs/latest/guide/) | Target taxonomy | Planning any scan |
| Container images | [Container image](https://trivy.dev/docs/latest/guide/target/container_image/) | Image sources, platform, digest/input behavior | Scanning images or registries |
| Filesystem | [Filesystem](https://trivy.dev/docs/latest/guide/target/filesystem/) | Local filesystem coverage | Scanning local projects/artifacts |
| Root filesystem | [Rootfs](https://trivy.dev/docs/latest/guide/target/rootfs/) | Unpacked rootfs semantics | Scanning hosts or unpacked images |
| Repository | [Code repository](https://trivy.dev/docs/latest/guide/target/repository/) | Remote/local repository behavior | Scanning a repository URL/ref |
| VM | [VM image](https://trivy.dev/docs/latest/guide/target/vm/) | VM-image support and limits | Scanning disk/VM images |
| Kubernetes | [Kubernetes](https://trivy.dev/docs/latest/guide/target/kubernetes/) | Cluster/resource/image behavior | Accessing a cluster |
| SBOM target | [SBOM](https://trivy.dev/docs/latest/guide/target/sbom/) | SBOM ingestion and limitations | Scanning an existing SBOM |
| Scanners overview | [Scanners](https://trivy.dev/docs/latest/scanner/vulnerability/) | Scanner taxonomy and defaults | Choosing scanners |
...
| CLI reference | [CLI commands](https://trivy.dev/docs/latest/references/configuration/cli/trivy/) | Current flags and command-specific behavior | Before freezing automation |
...
| Attestations | [Attestation](https://trivy.dev/docs/latest/guide/supply-chain/attestation/sbom/) | SBOM/scan-record attestation workflows | Signing/publishing attestations |
...
| Built-in compliance | [Built-in compliance](https://trivy.dev/docs/latest/compliance/compliance/) | Available reports and status | Running compliance evidence |
| Custom compliance | [Custom compliance](https://trivy.dev/docs/latest/compliance/contrib-compliance/) | Custom report definitions | Creating an organizational profile |
...
| Connectivity | [Network considerations](https://trivy.dev/docs/latest/guide/advanced/air-gap/) | Required endpoints and network behavior | Designing egress/proxy rules |
...
| Modes | [Standalone and client/server](https://trivy.dev/docs/latest/references/modes/client-server/) | Mode boundaries and server behavior | Deploying a Trivy server |
