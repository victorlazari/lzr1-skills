...
Recent updates include support for folders with limited access and content approvals.
...
| **Access Management** | Share files and configure user permissions, including limited access folders. | *"Share the 'Q3 Financials' spreadsheet with @finance_team and give them editor access."* |
