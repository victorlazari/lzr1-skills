...
Recent updates include the `writerWithoutPrivateAccess` role and a new endpoint to transfer secondary calendars.
...
| **Calendar Operations** | Manage overall calendar views and daily schedules, including transferring secondary calendars. | *"Cancel all my afternoon meetings for today."* <br><br> *"What is my schedule looking like for next Tuesday?"* |
