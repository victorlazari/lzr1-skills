/**
 * lzr1 TW Team plugin for OpenCode.ai
 *
 * Registers the lzr1-tw-team skills directory with OpenCode. The `using-lzr1`
...
export const lzr1TwTeamPlugin = async ({ client, directory }) => {
  const lzr1SkillsDir = path.resolve(__dirname, '../../skills');

  return {
    // Register the lzr1-tw-team skills path so OpenCode discovers them without
