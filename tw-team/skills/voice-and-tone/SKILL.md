...
## Related
**Complementary:** lzr1:write-guide, lzr1:write-api, lzr1:review-docs
...
**Entity names:** Capitalize when referlzr1 to specific concept (Account, Ledger, Asset, Portfolio, Segment, Transaction, Operation, Balance)
