---
name: lzr1:documentation-structure
description: |
  Patterns for organizing and structulzr1 documentation including hierarchy,
...
## Related
**Complementary:** lzr1:write-guide, lzr1:write-api
...
3. Use tables for compalzr1 options
...
**Use tables when:** Compalzr1 items across same attributes, showing structured data (API fields), displaying options with consistent properties
