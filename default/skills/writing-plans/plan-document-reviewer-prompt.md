...
**Dispatch after:** The complete plan is written and self-review (in `lzr1:writing-plans`) is done.
...
Agent tool (subagent_type: general-purpose):
  ...
  prompt: |
    ...
    **Only flag issues that would cause real problems dulzr1 implementation.**
